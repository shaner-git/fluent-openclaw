...
- package role: bundled OpenClaw helper copy for the Fluent open-source runtime export
...
- keep the minimum Fluent contract floor aligned to the current public contract, currently `2026-07-09.fluent-core-v2.0`
