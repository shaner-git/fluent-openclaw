...
- Claude, Codex, OpenClaw, and generic MCP clients support the Fluent contract as text-first clients. They should use the same durable tools and resources without relying on Fluent widgets unless the host explicitly proves MCP Apps-style widget support.
