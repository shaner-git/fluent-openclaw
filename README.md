...
- OpenClaw should be treated like Claude and Codex for Fluent UI expectations: use the relevant Fluent information and let the host present the results conversationally.
